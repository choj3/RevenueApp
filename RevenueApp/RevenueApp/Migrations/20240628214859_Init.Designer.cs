...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RevenueApp.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("RevenueApp.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("RevenueApp.Entities.Client", b =>
                {
            ...
            modelBuilder.Entity("RevenueApp.Entities.Company", b =>
                {
                    b.Property<int>("CompanyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RevenueApp.Entities.Configs.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RevenueApp.Entities.Contract", b =>
                {
            ...
            modelBuilder.Entity("RevenueApp.Entities.Discount", b =>
                {
            ...
            modelBuilder.Entity("RevenueApp.Entities.PrivateClient", b =>
                {
                    b.Property<int>("PrivateClientId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RevenueApp.Entities.SoftwareSystem", b =>
                {
                    b.Property<int>("SoftwareSystemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RevenueApp.Entities.SoftwareSystemVersion", b =>
                {
            ...
            modelBuilder.Entity("RevenueApp.Entities.Version", b =>
                {
                    b.Property<int>("VersionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RevenueApp.Entities.AppUser", b =>
                {
                    b.HasOne("RevenueApp.Entities.Configs.Role", "Role")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("RevenueApp.Entities.Client", b =>
                {
                    b.HasOne("RevenueApp.Entities.Company", "Company")
                        .WithMany("Clients")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("Client_Company");

                    b.HasOne("RevenueApp.Entities.PrivateClient", "PrivateClient")
                        .WithMany("Clients")
            ...
            modelBuilder.Entity("RevenueApp.Entities.Contract", b =>
                {
                    b.HasOne("RevenueApp.Entities.Client", "Client")
                        .WithMany("Contracts")
                    ...
                    b.HasOne("RevenueApp.Entities.SoftwareSystem", "SoftwareSystem")
                        .WithMany("Contracts")
            ...
            modelBuilder.Entity("RevenueApp.Entities.SoftwareSystemVersion", b =>
                {
                    ...
                    b.HasOne("RevenueApp.Entities.Version", "Version")
                        .WithMany("SoftwareSystemVersions")
            ...
            modelBuilder.Entity("SoftwareSystem_Category", b =>
                {
                    b.HasOne("RevenueApp.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RevenueApp.Entities.SoftwareSystem", null)
                        .WithMany()
                        .HasForeignKey("SoftwareSystemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SoftwareSystem_Discount", b =>
                {
                    b.HasOne("RevenueApp.Entities.Discount", null)
                        .WithMany()
