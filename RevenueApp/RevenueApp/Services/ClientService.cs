...
using RevenueApp.Repositories;

namespace RevenueApp.Services;
...
public class ClientService: IClientService
{
    ...
    public async Task<PrivateClientDTO?> GetPrivateClientAsync(int privateClientId, CancellationToken token)
    {
        var privateClient = await _clientRepository.GetPrivateClientByIdAsync(privateClientId, token);
